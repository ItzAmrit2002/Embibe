...
const QuestionPaper = () => {
  ...
  const getData = async () => {
    await axios
      .post("http://testhubbknd.onrender.com/api/student/getquestions", {
        paperid: pid,
      })
      .then((res) => {
        console.log(res);
    ...
    await axios
      .post("http://testhubbknd.onrender.com/api/student/paperinfo", {
        paperid: pid,
      })
      .then((res) => {
        console.log(res);
    ...
    await axios
      .post("http://testhubbknd.onrender.com/api/tally/countmarks", {
        paper_id: pid,
      })
      .then((res) => {
