...
const GivePaper = () => {
	...
	const getCount = async () => {
		let res = await axios.get("http://testhubbknd.onrender.com/api/student/givepaper")
		console.log(res.data)
		setCount(res.data)
	};

	const getData = async () => {
		let res = await axios.get("http://testhubbknd.onrender.com/api/student/getpapers");
		console.log(res.data)
