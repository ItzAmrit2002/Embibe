...
const QuestionCards = ({name, time, sub}) => {
    return (
        <Div d="flex" shadow="1" hoverShadow="3" h="6rem" w="auto" rounded="lg" hoverBg="rgba(193, 226, 223,0.25)" m={{ t: "3rem" }} justify="space-between" align="center" className="main-card" cursor="pointer">
            <Div d="flex" flexDir="column">
                ...
                <Div d="flex">
                    <Text textWeight="600" fontFamily="Montserrat" textSize="subheader" m={{ x: "2rem" }} textColor="#2b4641">No. Of Questions: 45</Text>
                    <Text textWeight="600" fontFamily="Montserrat" textSize="subheader" m={{ x: "2rem" }} textColor="#2b4641">Time: {time} minutes</Text>
                    <Text textWeight="600" fontFamily="Montserrat" textSize="subheader" m={{ x: "2rem" }} textColor="#2b4641">Marks: 100</Text>
